...
! function(t) {
    ...
    t.extend(t.fn, {
        ...
        rules: function(e, i) {
            ...
            if (null != h) {
                if (!h.form && d && (h.form = this.closest("form")[0], h.name = this.attr("name")), null != h.form) {
                    if (e) switch (n = (s = t.data(h.form, "validator").settings).rules, r = t.validator.staticRules(h), e) {
                        case "add":
                            ...
                            break;
                        case "remove":
                            if (!i) return delete n[h.name], r;
                            return l = {}, t.each(i.split(/\s/), function(t, e) {
                                l[e] = r[e], delete r[e]
                            }), l
                    }
    ...
    t.extend(t.expr.pseudos || t.expr[":"], {
        ...
        prototype: {
            ...
            element: function(e) {
                ...
                }), i = !1 !== this.check(r), o = o && i, i ? this.invalid[r.name] = !1 : this.invalid[r.name] = !0, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), t(e).attr("aria-invalid", !i)), o
            },
        ...
        normalizeAttributeRule: function(t, e, i, s) {
            /min|max|step/.test(i) && (null === e || /number|range|text/.test(e)) && isNaN(s = Number(s)) && (s = void 0), s || 0 === s ? t[i] = s : e === i && "range" !== e && (t["date" === e ? "dateISO" : i] = !0)
        },
        ...
        methods: {
            ...
            step: function(e, i, s) {
                var n, r = t(i).attr("type"),
                    ...
                    d = !0;
                if (o) throw Error("Step attribute on input type " + r + " is not supported.");
