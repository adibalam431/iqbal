...
! function(t, e) {
    ...
    function A(t, e) {
        ...
        if (p.length || p.push(x(t, 1), x(t, 2), x(t, 3)), i = l ? f : c, l) u ? (a = -(r = z(t)).e / r.a, s = -r.f / r.d, n = d) : t.getBBox ? (r = t.getBBox(), a = (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems ? 1 < n.numberOfItems ? function _consolidate(t) {
            ...
            return e
        }(n) : n.getItem(0).matrix : d).a * r.x + n.c * r.y, s = n.b * r.x + n.d * r.y) : (n = new _, a = s = 0), e && "g" === t.tagName.toLowerCase() && (a = s = 0), (u ? l : h).appendChild(i), i.setAttribute("transform", "matrix(" + n.a + "," + n.b + "," + n.c + "," + n.d + "," + (n.e + a) + "," + (n.f + s) + ")");
        else {
            if (a = s = 0, m)
    ...
    function ia(e, i, n) {
        ...
        for (a = "none" === c("display"), e.isVisible && !a || (a && (ea(e, ["display"]).display = i.display), e.matrix = i.matrix, e.width = l = e.width || i.width, e.height = p = e.height || i.height), ea(e, I), s = window.getComputedStyle(o); d--;) f[I[d]] = s[I[d]];
    ...
    function za(t, e, r, i) {
        ...
        var a, s, o, l, u, p, h, c, f, n, d, m, g, y, v, x = (r = r || {}).clearProps,
            b = r.onEnter,
            w = r.onLeave,
            S = r.absolute,
            k = r.absoluteOnLeave,
            ...
            q = [],
            U = !0 === N ? 1 : N || 0,
            H = "function" == typeof N ? N : function() {
                return U
            },
            Z = t.interrupted || e.interrupted,
            K = D[1 !== i ? "to" : "from"];
        for (s in e.idLookup) d = e.alt[s] ? ua(e, t, s) : e.idLookup[s], u = d.element, n = t.idLookup[s], !t.alt[s] || u !== n.element || !t.alt[s].isVisible && d.isVisible || (n = t.alt[s]), n ? (p = {
            t: u,
            b: n,
            a: d,
            sd: n.element === u ? 0 : d.isVisible ? 1 : -1
        }, G.push(p), p.sd && (p.sd < 0 && (p.b = d, p.a = n), Z && ea(p.b, X ? et[X] : nt), P && G.push(p.swap = {
            t: n.element,
            b: p.b,
            a: p.a,
            sd: -p.sd,
            swap: p
        })), u._flip = n.element._flip = tt ? tt.timeline : D) : d.isVisible && (G.push({
            t: u,
            b: $(d, {
                isVisible: 1
            }),
        ...
        X && (st[X] || aa(X)).forEach(function(e) {
            ...
            if (F && (e = f.map(function(t) {
                ...
                }, z.zIndex = L, z.immediateRender = !1 !== r.immediateRender), P && (z.opacity = function(t) {
            ...
            if (it.forEach(function(t) {
                ...
                for (s in R = $(z, rt), "scale" in C && (C.scaleX = C.scaleY = C.scale, delete C.scale), C)(a = $(C[s], at))[s] = z[s], !("duration" in a) && "duration" in z && (a.duration = z.duration), a.stagger = z.stagger, K.call(D, c, a, 0), delete R[s];
            (c.length || j.length || Y.length) && (F && D.add(function() {
                return W(e, F, D._zTime < 0 ? "remove" : "add")
            }, 0) && !_ && W(e, F, "add"), c.length && K.call(D, c, R, 0)), ra(b, Y, D), ra(w, j, D);
            var n = tt && tt.timeline;
            n && (n.add(D, 0), tt._final.push(function() {
                return ga(G, !x)
            })), o = D.duration(), D.call(function() {
                var t = D.time() >= o;
                t && !n && ga(G, !x), F && W(e, F, t ? "remove" : "add")
            })
        }, k && (S = G.filter(function(t) {
            return !t.sd && !t.a.isVisible && t.b.isVisible
        }).map(function(t) {
            return t.a.element
        })), tt ? (S && (v = tt._abs).push.apply(v, ja(G, S)), tt._run.push(m)) : (S && ka(ja(G, S)), m());
    ...
    var T, Q, tt, s, o, P, l, n, h = 1,
        ...
        nt = R("transform,transformOrigin,width,height,position,top,left,opacity,zIndex,maxWidth,maxHeight,minWidth,minHeight"),
        rt = {
            zIndex: 1,
            kill: 1,
            simple: 1,
        ...
        L = function _parseElementState(t, e, i, n) {
            ...
            }(t, n) : new pt("string" == typeof t ? U(t) || console.warn(t + " not found") : t, e, i)
        },
        ot = function _fit(t, e, i, n, r, a) {
            var s, o, l, u, p, h, c, f = t.element,
                ...
                M = B.e,
                F = B.f,
                I = t.bounds.width !== k.width || t.bounds.height !== k.height || t.scaleX !== b || t.scaleY !== w || t.rotation !== S,
                L = !I && t.simple && e.simple && !r;
            return L || !m ? (b = w = 1, S = s = 0) : (h = (p = function _getInverseGlobalMatrix(t) {
            ...
            }(m)).clone().multiply(e.ctm ? e.matrix.clone().multiply(e.ctm) : e.matrix), S = V(Math.atan2(h.b, h.a) * O), s = V(Math.atan2(h.c, h.d) * O + S) % 360, b = Math.sqrt(Math.pow(h.a, 2) + Math.pow(h.b, 2)), w = Math.sqrt(Math.pow(h.c, 2) + Math.pow(h.d, 2)) * Math.cos(s * N), r && (r = T(r)[0], u = Q.getProperty(r), c = r.getBBox && "function" == typeof r.getBBox && r.getBBox(), E = {
                scaleX: u("scaleX"),
                scaleY: u("scaleY"),
                width: c ? c.width : Math.ceil(parseFloat(u("width", "px"))),
                height: c ? c.height : parseFloat(u("height", "px"))
            }), d.rotation = S + "deg", d.skewX = s + "deg"), i ? (b *= v !== E.width && E.width ? v / E.width : 1, w *= x !== E.height && E.height ? x / E.height : 1, d.scaleX = b, d.scaleY = w) : (v = P(v * b / E.scaleX, 0), x = P(x * w / E.scaleY, 0), f.style.width = v + "px", f.style.height = x + "px"), n && oa(f, e.props), L || !m ? (g += M - t.matrix.e, y += F - t.matrix.f) : I || m !== e.parent ? (d.renderTransform(1, d), h = getGlobalMatrix(r || f, !1, !1, !0), o = p.apply({
                x: h.e,
                y: h.f
            }), g += (l = p.apply({
                x: M,
                y: F
            })).x - o.x, y += l.y - o.y) : (p.e = p.f = 0, g += (l = p.apply({
                x: M - t.matrix.e,
                y: F - t.matrix.f
            })).x, y += l.y), g = P(g, .02), y = P(y, .02), !a || a instanceof pt ? (d.x = g + "px", d.y = y + "px", d.renderTransform(1, d)) : (f.style.cssText = C, f.getBBox && f.setAttribute("transform", _ || ""), d.uncache = 1), a && (a.x = g, a.y = y, a.rotation = S, a.skewX = s, i ? (a.scaleX = b, a.scaleY = w) : (a.width = v, a.height = x)), a || d
        },
        X = [],
        ...
        ut = ((n = FlipState.prototype).update = function update(t) {
            ...
            for (var n, r, a = da(this.elementStates.slice(0), !1, !0), s = (t || this).idLookup, o = 0; o < a.length; o++) n = a[o], i && (n.matrix = getGlobalMatrix(n.element, !1, !1, !0)), (r = s[n.id]) && ot(n, r, e, !0, 0, n), n.matrix = getGlobalMatrix(n.element, !1, !1, !0);
            return this
            ...
            for (var t = et[this.props] || nt, e = this.elementStates.length; e--;) ea(this.elementStates[e], t)
    ...
    function FlipState(t, e, i) {
        if (this.props = e && e.props, this.simple = !(!e || !e.simple), i) this.targets = qa(t), this.elementStates = t, Ca(this);
        else {
            this.targets = T(t);
    ...
    var Y, pt = ((Y = ElementState.prototype).isDifferent = function isDifferent(t) {
        var e = this.bounds,
            i = t.bounds;
        ...
        var n = this,
            ...
            p = i ? new _(1, 0, 0, 1, o.left + u(), o.top + t()) : getGlobalMatrix(r, !1, !1, !0);
        ...
        }(n, st[e] || aa(e)), n.ctm = r.getCTM && "svg" === r.nodeName.toLowerCase() && z(r).inverse(), n.simple = i || 1 === V(p.a) && !V(p.b) && !V(p.c) && 1 === V(p.d), n.uncache = 0
    }, ElementState);

    function ElementState(t, e, i) {
        this.element = t, this.update(e, i)
    }
    var j, G = ((j = FlipAction.prototype).getStateById = function getStateById(t) {
    ...
    var q, H = ((q = FlipBatch.prototype).add = function add(e) {
        var t = this.actions.filter(function(t) {
            return t.vars === e
        });
        return t.length ? t[0] : (t = new G("function" == typeof e ? {
            animate: e
        ...
        for (tt = this, r.clear(), this._abs.length = this._final.length = this._run.length = 0, this.actions.forEach(function(t) {
                ...
                a && a.length && (n || r) && (e = new ut, t.states.forEach(function(t) {
                    return e.add(t)
                }), (i = e.compare(J.getState(a))).enter.length && n && n(i.enter), i.leave.length && r && r(i.leave))
    ...
    var J = (Flip.getState = function getState(t, e) {
        var i = ta(t, e);
        ...
        }), a && ia(d, f), n = ot(d, f, s || c, l, c, n.duration || o ? n : 0), o ? n : n.duration ? Q.to(d.element, n) : null
    ...
    function Flip() {}
    J.version = "3.11.4", "undefined" != typeof window && window.gsap && window.gsap.registerPlugin(J), e.Flip = J, e.default = J;
